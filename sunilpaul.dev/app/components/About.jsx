      ...
      <div className="flex w-full flex-col lg:flex-row items-center gap-24 my-12 sm:my-20">
        ...
        <div className="flex-1">
          <p className="max-w-2xl text-gray-300 leading-relaxed">
            I’m <span className="font-semibold text-white">Sunil Paul</span>, a
            passionate software developer currently working on an exciting
            project called <span className="italic">Trace</span>.<br />
            <br />
            💻 I specialize in building dynamic, user-friendly applications with
            a strong focus on usability and performance.
            <br />
            <br />
            🤝 I love working with developers and creative professionals to
            bring innovative ideas to life.
            <br />
            <br />
            🤖 Lately, I’ve been exploring the world of Large Language Models
            (LLMs) and their potential to reshape how we build software.
          </p>
