    ...
    >
      <div className="relative w-32 h-32">
        ...
        <Image
          ...
          width={500}
          quality={100}
          alt="Sunil Paul's Profile Picture"
          className="relative rounded-full object-cover"
        />
      </div>

      <h1 className="font-semibold text-2xl sm:text-6xl lg:text-[62px]">
        Hi there!<span className=" text-blue-700"> I'm Sunil.</span>
      </h1>
      <p className="max-w-2xl mx-auto text-gray-200">
        I'm a web designer and developer based in the United Kingdom,
        specializing in creating functional, visually appealing, and
        user-friendly websites and applications tailored to business needs.
      </p>
